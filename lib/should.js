 ...
 * @api public
 */
if(Object.prototype.should) // just incase this has been called again.
  return
...
var Assertion = exports.Assertion = function Assertion(obj,description) {
  this.obj = obj;
  this.description = description;
  //  description = description || i(obj)
  this.message = []
  if(description)
    this.message.push(description)

  this.message.push(obj)
  this.message.push('should')
};

/**
 * attach a text description to an object to be shoulded
 * 
 * @param {Mixed} obj
...
exports.describe = function (it,description) {
  return { get should () {
     return new Assertion(it,description)
    }
  }
}
...
Assertion.prototype = {
  ...
  assert: function(expr, msg, negatedMsg){
    ...
    var ok = this.negate ? !expr : expr
      , msg = //(this.description ? this.description : '')
          //+ '(' + this.inspect + ') '
          ''
          + this.message.map(
            function (s){
...
//    this.$('length')
    ...
    this.assert(
        n == len
      , ' length of ' + n + ' but got ' + len
      , ' length anything except ' + len);
    return this;
  },
  ...
  property: function(name, val){
    ...
    //gotta change this. i know, just build up the message as we go...
    return this;
  },
